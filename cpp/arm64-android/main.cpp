...
void test_mdd() {
   ...
   Halide::Tools::save_image(output_image_mdd, "output_image_mdd.png");
}
...
void test_ps() {
   ...
   Halide::Tools::save_image(output_image_ps, "output_image_ps.png");
}
...
void test_pdrt2() {
   ...
   Halide::Tools::save_image(output_image_ps, "output_image_pdrt2.png");
}
...
void test_pdrt32() {
   ...
   Halide::Tools::save_image(output_image_ps, "output_image_pdrt32.png");
}
