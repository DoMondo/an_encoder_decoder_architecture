...
class PDRT32ThresholdJet_generator : public Halide::Generator<PDRT32ThresholdJet_generator> {
private:
...
HALIDE_REGISTER_GENERATOR(PDRT32ThresholdJet_generator, pdrt32_threshold_jet)
